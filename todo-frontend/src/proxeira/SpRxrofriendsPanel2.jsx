...
const currentUser = JSON.parse(localStorage.getItem('user')) // PROSOXH EDWWWW
...
const FriendsPanel = () => {
  ...
  const [showChatModal, setShowChatModal] = useState(false) //GIA PAME PAPAPA
      ...
      <ul className='friends-panel__list'>
        ...
        {showChatModal && selectedFriend && (
          <div className='chat-modal'>
            <ChatWindow currentUser={currentUser} friend={selectedFriend} />
